...
tar -czvf configs.tgz ./jcasc.yaml ./groovy_scripts/helloworld.groovy ./groovy_scripts/wizard.groovy ./groovy_scripts/login.groovy ./groovy_scripts/static-site.groovy ./groovy_scripts/JenkinsAMI.groovy ./groovy_scripts/StaticSiteMultiPipeline.groovy ./groovy_scripts/Terraform.groovy ./groovy_scripts/Helm-Webapp-Cve-Processor ./groovygroovy_scripts/k8s-manifests.groovy 
