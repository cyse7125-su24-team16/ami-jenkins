...
#Creating a tar file of all the associated configuration file.
tar -czvf configs.tgz ./jcasc.yaml ./groovy_scripts/helloworld.groovy ./groovy_scripts/wizard.groovy ./groovy_scripts/login.groovy ./groovy_scripts/static-site.groovy ./groovy_scripts/JenkinsAMI.groovy ./groovy_scripts/StaticSiteMultiPipeline.groovy ./groovy_scripts/Terraform.groovy ./groovy_scripts/Helm-Webapp-Cve-Processor.groovy ./groovy_scripts/k8s-manifests.groovy ./groovy_scripts/Webapp-Cve-Processor.groovy ./groovy_scripts/AWS-Infra.groovy ./groovy_scripts/Consumer-Webapp.groovy ./groovy_scripts/Helm-Consumer.groovy ./groovy_scripts/eks-autoscaler.groovy ./groovy_scripts/Cve-Operator.groovy ./groovy_scripts/Project.groovy
